...
public class UnoTableManager {
    ...
    private final com.fkc.game.core.PlayerPreferenceStore cardDisplayPrefs = new com.fkc.game.core.PlayerPreferenceStore();
    ...
    public UnoTable create(UUID hostUuid, String hostName) {
        ...
        table.cardDisplayPrefs = cardDisplayPrefs;

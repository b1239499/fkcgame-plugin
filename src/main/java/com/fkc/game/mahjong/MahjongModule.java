...
public final class MahjongModule implements GameModule {
    ...
    public void onEnable(Plugin plugin) {
        ...
        com.fkc.game.core.RewardItemStore rewardStore = new com.fkc.game.core.RewardItemStore(plugin.getDataFolder(), "reward-item.yml");
        tableManager.rewardStore = rewardStore;

        var command = Bukkit.getPluginCommand("mahjong");
        if (command != null) {
            MahjongCommand executor = new MahjongCommand(tableManager, plugin, economy);
